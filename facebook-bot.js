        ...
        if (text) {
            ...
            apiaiRequest.on('response', (response) => {
                if (this.isDefined(response.result) && this.isDefined(response.result.fulfillment)) {
                    console.log('Response from API.AI ', response, response.result.fulfillment.messages);
                    ...
                    if(action === 'getBalance' && intent === 'balance') {
                        if (this.isDefined(responseText)) {
                            this.doTextResponse(sender, 'Your current balance is EUR 1000');
                        }
                    }
